...
![pull request CI trigger](images/continuous-integration/ci_pull_command.png)
...
![CI Progress](images/continuous-integration/ci_pending.png)

When tests complete, that result is also updated in the pull request

![CI Pass](images/continuous-integration/ci_pass.png)

If there are issues found during testing, you will get a link to the details of the failure.

![CI Failure](images/continuous-integration/ci_failure.png)

It is expected that changes meet the [quality standards](./contributing-code.md#quality) for the Swift project before they are committed to the development branch, and you are responsible for fixing problems found by your changes. If your changes break builds or tests on the development or release branches, you will receive email notification.
