...
* works with the [Swift Core Team](https://www.swift.org/community/#community-structure) to define a roadmap for the focus areas of language and library development in the upcoming releases of Swift.
...
- Tony Allevato ([@allevato](https://github.com/allevato))
- Holly Borla ([@hborla](https://github.com/hborla))
- Steve Canon ([@stephentyrone](https://github.com/stephentyrone))
- Ben Cohen ([@airspeedswift](https://github.com/airspeedswift))
- Doug Gregor ([@DougGregor](https://github.com/DougGregor))
- Joe Groff ([@jckarter](https://github.com/jckarter))
- Freddy Kellison-Linn ([@Jumhyn](https://github.com/Jumhyn))
- John McCall, Chair ([@rjmccall](https://github.com/rjmccall))
- Becca Royal-Gordon ([@beccadax](https://github.com/beccadax))
- Xiaodi Wu ([@xwu](https://github.com/xwu))
...
* It reviews the technical content of any language and library documentation hosted on [swift.org](https://swift.org/), but editorial authority over that documentation rests with the Website Workgroup or other groups as appropriate.
...
The Language Steering Group follows the Swift [Code of Conduct](https://www.swift.org/code-of-conduct/). Instances of abusive, harassing, or otherwise unacceptable behavior may be reported by contacting the workgroup chair or a member of the [Swift Core Team](https://www.swift.org/community/#community-structure) or by flagging the behavior for moderation, whether you are the target of that behavior or not.
